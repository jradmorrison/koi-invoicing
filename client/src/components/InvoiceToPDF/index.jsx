...
const InvoiceToPDF = ({
  ...
  return (
    // return invoice page with invoice and 2 buttons
          ...
          <div style={{ padding: '1rem' }}>
            ...
            <div
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <h3 style={{ paddingBottom: '.2rem', fontSize: '1rem' }}>
                  {name}
                </h3>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div
              ...
              <h3 style={{ paddingRight: '5rem', fontSize: '1.2rem' }}>
                Total Due
              </h3>
              <h3 style={{ paddingRight: '2rem', fontSize: '1.2rem' }}>
